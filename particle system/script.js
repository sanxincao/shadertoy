var m_IndexContainer;
var m_Camera, m_Renderer;
var m_Controls;

var TheScene;

var TheParticleCount = 100000; 
var mParticleSystem;
...
function initTHREE() {
  ...
  m_IndexContainer = document.getElementById('three-container');
  m_IndexContainer.appendChild(mRenderer.domElement);
...
function initParticleSystem() {
  ...
  var bufferGeometry = new THREE.BAS.PrefabBufferGeometry(prefabGeometry, TheParticleCount);
  ...
  for (i = 0, offset = 0; i < TheParticleCount; i++) {
    delay = i / TheParticleCount * mDuration;
...
function render() {
  mRenderer.render(TheScene, mCamera);
}
